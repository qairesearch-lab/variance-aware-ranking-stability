...
Status: frozen schema, organamnist download/data facts verified (2026-04-25), sipakmed data structure verified (2026-04-26)
Frozen on: 2026-04-25
Scope: Primary analysis datasets in `datasets.yaml`

## Purpose

This file freezes the field schema for dataset sources and version records. Fact fields such as download date, file hashes, local paths, and actual sample counts must be completed after data download and verification; do not fill them in before verification.
...
file_hashes:
  ...
  primary_image_relative_path_list_hash_command: >
    tail -n +2 checksums/sipakmed_primary_images_sha256.csv
    | cut -d, -f1 | LC_ALL=C sort | shasum -a 256
  primary_image_content_sha256_manifest: checksums/sipakmed_primary_images_sha256.csv
  primary_image_content_sha256_manifest_sha256: 1d2f9e512b3f3e668b255ec293e401b5ce9e4cf52f735db13473daccd972db41
...
reorganized_date: 2026-04-26
reorganization_note: >
  Data folders im_* moved from data/processed/ to data/sipakmed/raw/ (2026-04-26).
...
file_hashes:
  ...
  primary_image_relative_path_list_hash_command: >
    tail -n +2 checksums/organamnist_primary_images_sha256.csv
    | cut -d, -f1 | LC_ALL=C sort | shasum -a 256
  primary_image_content_sha256_manifest: checksums/organamnist_primary_images_sha256.csv
  primary_image_content_sha256_manifest_sha256: 74977d371c804c9fa48db29743e4db2f50d8e980d02d7bd8d06805d06780b437
...
- Download dates, local paths, observed sample counts, class mappings, and file hashes are recorded for SIPaKMeD and OrganAMNIST.
- Per-image SHA-256 checksum manifests are recorded for both primary datasets under `checksums/`.
