...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="research-lab/experiments/registered-workflow/stats/tables/supplementary_information.md",
    )
