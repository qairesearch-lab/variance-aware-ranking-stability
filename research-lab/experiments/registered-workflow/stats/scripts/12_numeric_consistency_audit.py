#!/usr/bin/env python3
"""Generate a manuscript numeric-consistency audit table for the CMPB v0.3 fork."""
    ...
    for dataset, policy, label in STRATA:
        ...
        output.append(
            row(
                ...
                "yes",
                "Retain; Monte Carlo Wilson 95% CIs have been added to the v0.3 manuscript text.",
            )
        )
        ...
        output.append(
            row(
                ...
                "explained",
                "Clarify in v0.3 that this value is averaged across the 50 single split-seed contexts.",
            )
        )
